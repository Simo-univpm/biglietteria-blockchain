...
class Login extends Form{
    ...
    constructor(){
        ...
        this.addField("email","E-mail","email") //Aggiunge il campo per inserire il nome utente
        this.addField("password","Password","password") //Aggiunge il campo per inserire la password
