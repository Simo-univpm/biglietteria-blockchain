...
// Testare bene tutte le rotte del sito

//!!!! DOMANDE ========================================================================

//!!!! FATTO ==========================================================================
// Decrementare numero posti quando si compra un biglietto
// implementare interazione col contratto in .../success (non si chiama più success, vedi emetti-biglietti)
// Implementa chiudi vendite (bisogna aggiornare lo smart contract)
// fare contratto
// Blocca wallet con password
// User va messo dentro header
// Abi salvata sul db
