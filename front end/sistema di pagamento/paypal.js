...
class Paypal {
    ...
    richiestaPagamento(res,userID,eventID,prezzo,numero_biglietti){
        ...
        const create_payment_json = {
            ...
            "redirect_urls": {
                "return_url": "https://localhost:8080/api/tickets/success",  //URL cui si viene reindirizzati se la richiesta ha successo
                "cancel_url": "https://localhost:8080/api/tickets/cancel"    //URL cui si viene reindirizzati se la richiesta fallisce
            },
            "transactions": [{
                "item_list": {
                    "items": [{
