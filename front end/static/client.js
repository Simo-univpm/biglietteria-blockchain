...
async function createEvent(){
    ...
    data.Icona_evento = await readFile(document.getElementById("Icona_evento").files[0])    //Legge l'immagine dal file system del client (l'immagine viene memorizzata come una stringa binaria base64)
