...
class HTMLpage
{
    ...
    constructor(user=null){
        ...
        if (user!=null){
            ...
            this.bar.addItem(user.email,"window.location.href='/area-riservata'");   //Aggiunge al menu a tendina della barra il pulsante per accedere all'area riservata

            if (user.privileges == 0)   this.bar.addItem("I miei biglietti","/");    //Se l'utente è un cliente, aggiunge al menu a tendina della barra il pulsante per vedere i biglietti acquistati

            else if (user.privileges == 1)  this.bar.addItem("Crea nuovo evento","window.location.href='/new-event'");   //Se l'utente è un event manager, aggiunge al menu a tendina della barra il pulsante per creare un nuovo evento
            ...
            else if (user.privileges == 3)  this.bar.addItem("Biglietti invalidati","/");    //Se l'utente è un annulaltore, aggiunge al menu a tendina della barra il pulsante per visulizzare la lista dei biglietti invalidati
